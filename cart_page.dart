            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(product.productName,style:TextStyle(fontSize: 30, overflow: TextOverflow.ellipsis),),
                    Text(product.description,style:TextStyle(fontSize: 15, overflow: TextOverflow.ellipsis),),
                  ],
                ),
              ),
